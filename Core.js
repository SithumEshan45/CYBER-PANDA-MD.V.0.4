...
if (time2 < "05:00:00") {
  nowtime = '𝘎𝘖𝘖𝘋 𝘕𝘐𝘎𝘏𝘛 🦋💞 Powered By ⃞💙𝗔𝘂𝗿𝗮™';
} else if (time2 < "11:00:00") {
  nowtime = '𝘎𝘖𝘖𝘋 𝘔𝘖𝘙𝘕𝘐𝘕𝘎 💞🦋 Powered By ⃞💙𝗔𝘂𝗿𝗮™';
} else if (time2 < "15:00:00") {
  nowtime = '𝘎𝘖𝘖𝘋 𝘈𝘍𝘛𝘌𝘙𝘕𝘖𝘖𝘕 💞🦋 Powered By ⃞💙𝗔𝘂𝗿𝗮™';
} else if (time2 < "18:00:00") {
  nowtime = '𝘎𝘖𝘖𝘋 𝘌𝘝𝘌𝘕𝘐𝘕𝘎 💞🦋 Powered By ⃞💙𝗔𝘂𝗿𝗮™';
